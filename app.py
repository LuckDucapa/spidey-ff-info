# ------------------------------------------------------------
# Free Fire Account Info API — Credit: @spidey_abd
# JOIN    : @spidey_abd  FOR MORE SRC | API | BOT CODE | METHOD | 🛐
# Purpose : Fetch Free Fire profile details using UID (JWT + AES)
# Note    : THIS CODE MADE BY 
#@spidey_abd - KEEP CREDIT
# Info Endpoint: /info?uid=<PLAYER_UID>&region=<REGION>
# Info Example : /info?uid=7344010091&region=IND
# Wishlist Endpoint : /wishlist?uid=<PLAYER_UID>&region=<REGION>
# Wishlist Example : /wishlist?uid=7344010091&region=IND
...
def get_wishlist_info():
    try:
        ...
        # Prepare Request using GetWishListItems_pb2
        ...
        # Determine URL: Modify the existing endpoint to point to GetWishListItems
